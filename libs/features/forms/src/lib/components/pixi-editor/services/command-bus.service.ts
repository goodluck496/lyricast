...
export type EditorCommand =
  ...
  | { t: 'ADD_BRUSH'; path: { x: number; y: number }[]; x?: number; y?: number; options?: { width?: number; height?: number; rotation?: number; alpha?: number; stroke?: number; strokeWidth?: number; bgAssetId?: string; } }
  ...
  | { t: 'SET_SHAPE_BACKGROUND'; url?: string; assetId?: string; }  // Установить фоновое изображение для фигуры
  ...
  | { t: 'SET_TEXT_BACKGROUND'; url?: string; assetId?: string; }  // Установить фоновое изображение для текста
  ...
  | { t: 'SET_BRUSH_BACKGROUND'; url?: string; assetId?: string; }  // Установить фоновое изображение для кисти
